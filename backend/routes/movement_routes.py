...
from backend.services.moviment_service import create_entry_service, create_exit_service, create_loss_service, get_movement_by_id_service, list_movements_service
